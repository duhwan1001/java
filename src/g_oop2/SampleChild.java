...
public class SampleChild extends SampleParent{
	...
	void test(double var){
		...
		//super : 부모 클래스의 멤버와 자식 클래스의 멤버가 이름이 중복될 때 둘을구분하기 위해 사용한다.
	...
	SampleChild(){
		...
		//super()가 없으면 컴파일러가 자동으로 super를 넣어준다
	}
	...
	public static void main(String[] args) {
		...
		sc = (SampleChild)sp; // sc = sp 불가능
		sp = (SampleParent)sc; // sp = sc 가능
